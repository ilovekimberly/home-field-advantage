...
export async function POST(req: Request) {
    ...
    body: JSON.stringify({
      ...
      html: `
        <div style="font-family: -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px 24px;">
          <h1 style="font-size: 24px; color: #0b1f3a; margin-bottom: 8px;">
          ...
          <p style="color: #444; font-size: 16px; line-height: 1.5;">
            Each night of the slate you'll take turns drafting game picks.
            Best record wins.
          </p>
          <a href="${inviteUrl}"
  ...
  if (!emailRes.ok) {
    ...
    return NextResponse.json({ error: "Failed to send email", detail: errBody }, { status: 502 });
  }
